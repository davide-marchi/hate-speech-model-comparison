...
\sisetup{round-mode=places,round-precision=2,detect-all=true,output-exponent-marker=\mathrm{e}}
...
\begin{itemize}
    ...
    \item \textbf{Zero-shot (DistilBERT-MNLI)}: using the pretrained model \texttt{distilbert-base-uncased-mnli} \cite{sanh2019distilbert} with an NLI-based zero-shot pipeline \cite{wolf2020transformers}.
\end{itemize}
